...
def assert_same_length_input_output_args():
    if len(args.audio) != len(args.outfile) or len(args.audio) != len(args.face):
        parser.error("The number of --input and --output arguments must be the same.")

def parse_args():
    args = parser.parse_args()
    assert_same_length_input_output_args()
    return args
